...
A custom Python Instruction Set Simulator (`riscv\_iss.py`) executes the same program independently from the RTL implementation.
...
assign imm = {{20{if\_id\_instr}}, if\_id\_instr\[31:20]};
...
!\[Terminal Output](docs/riscv\_core\_terminal\_pass.png.png)
...
!\[Waveform](docs/riscv\_core\_waveform.png)
